...
Gem::Specification.new do |s|
  ...
  s.files = [
    "CHANGES",
     ...
     "vendor/js-test-core/bin/js-test-client",
     "vendor/js-test-core/bin/js-test-server",
     ...
     "vendor/js-test-core/lib/js_test_core/representations/frameworks.rb",
     ...
     "vendor/js-test-core/lib/js_test_core/representations/suite.html.rb",
     "vendor/js-test-core/lib/js_test_core/representations/suites.rb",
     "vendor/js-test-core/lib/js_test_core/representations/suites/screw_unit.html.rb",
     ...
     "vendor/js-test-core/public/js_test_server.js",
     "vendor/js-test-core/spec/example_framework/JsTestCore.css",
     "vendor/js-test-core/spec/example_framework/JsTestCore.js",
     "vendor/js-test-core/spec/example_framework/subdir/SubDirFile.js",
     "vendor/js-test-core/spec/example_root/favicon.ico",
     "vendor/js-test-core/spec/example_root/javascripts/foo.js",
     "vendor/js-test-core/spec/example_root/javascripts/large_file.js",
     "vendor/js-test-core/spec/example_root/javascripts/subdir/bar.js",
     "vendor/js-test-core/spec/example_root/robots.txt",
     "vendor/js-test-core/spec/example_root/stylesheets/example.css",
     "vendor/js-test-core/spec/example_spec/custom_dir_and_suite/passing_spec.js",
     "vendor/js-test-core/spec/example_spec/custom_suite.html",
     "vendor/js-test-core/spec/example_spec/failing_spec.js",
     "vendor/js-test-core/spec/example_spec/foo/failing_spec.js",
     "vendor/js-test-core/spec/example_spec/foo/passing_spec.js",
     "vendor/js-test-core/spec/example_spec/passing_spec.js",
     "vendor/js-test-core/spec/functional/functional_spec.rb",
     "vendor/js-test-core/spec/functional/functional_spec_helper.rb",
     "vendor/js-test-core/spec/functional/functional_spec_server_starter.rb",
     "vendor/js-test-core/spec/functional_suite.rb",
     ...
     "vendor/js-test-core/standalone.ru",
     ...
     "vendor/js-test-core/vendor/lucky-luciano/lib/lucky_luciano/resource/path.rb",
